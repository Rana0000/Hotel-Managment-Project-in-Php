<?php require_once "inc/header.php"; ?>
    <section class="site-hero inner-page overlay" style="background-image: url(src/images/contact.jpg)" data-stellar-background-ratio="0.5">
      <div class="container">
    ...
    <!-- END section -->
    <section class="section contact-section" style="margin-left:350px;" id="next">
      <div class="container">
        <div class="row">
